  ...
  <div class="mod_picfold clearfix">
    <div class="clearfix" id="detail_main_img">
     ...
     <div id="vertical" class="bigImg">
		<img src="{{asset('mid/01.jpg')}}" width="" height="" alt="" id="midimg" />
     ...
     <div class="smallImg">
		...
		<div id="imageMenu">
			<ul>
				<li><img src="{{asset('small/01.jpg')}}" width="68" height="68" alt="洋妞"/></li>
				<li><img src="{{asset('small/02.jpg')}}" width="68" height="68" alt="洋妞"/></li>
				<li><img src="{{asset('small/03.jpg')}}" width="68" height="68" alt="洋妞"/></li>
				<li><img src="{{asset('small/04.jpg')}}" width="68" height="68" alt="洋妞"/></li>
				<li><img src="{{asset('small/05.jpg')}}" width="68" height="68" alt="洋妞"/></li>
				<li><img src="{{asset('small/06.jpg')}}" width="68" height="68" alt="洋妞"/></li>
                <li><img src="{{asset('small/07.jpg')}}" width="68" height="68" alt="洋妞"/></li>
			</ul>
		</div>
  ...
  <!--收藏-->
   ...
   <!--信息样式-->
    ...
    <form action="javascript:addToCart(97)" name="ECS_FORMBUY" id="ECS_FORMBUY">
	  <div class="title"><h1>Mixx {{$list->Gname}} 600g 马来西亚进口</h1><p>{{$list->Gdetail}}</p></div>
	  <div class="mod_detailInfo_priceSales">
	  <div class="margins">
	  <div class="Price clearfix text_name"><label>价格</label><span class="Prices"><h4>¥{{$list->Gpice}}</h4> <b>34.00</b></span></div>
	  <div class="Activity clearfix text_name"><label>重量</label><span class="weight">345克</span></div>
      <div class="Size clearfix text_name"><label>规格</label><a href="#">礼盒装</a></div>
	 ...
	 <div class="buyinfo" id="detail_buyinfo">
        ...
        <div data-trigger="spinner">
          <a class="btn-reduce"  href="javascript:;" data-spin="down">-</a>
          <input type="text" value="1" data-rule="quantity" name="num">
          <a class="btn-add" href="javascript:;" data-spin="up">+</a>
        </div>
  ...
  <div class="left_style">
   <div class="Records">
	 ...
	 <ul>
	  <li>
	   <a href="#">
	   <p><img src="{{asset('Products/4.jpg')}}" data-bd-imgshare-binded="1"></p>
	  ...
	  <li>
	   <a href="#">
	   <p><img src="{{asset('Products/5.jpg')}}" data-bd-imgshare-binded="1"></p>
	  ...
	  <li>
	   <a href="#">
	   <p><img src="{{asset('Products/3.jpg')}}" data-bd-imgshare-binded="1"></p>
	   <p class="p_name">商品名称</p>
	   </a>
	   <p><span class="p_Price">￥5.30</span><b>10.4</b></p>
	  </li>
   ...
   <div class="right_style">
    <div class="inDetail_boxOut ">
	 <div class="inDetail_box">
      ...
      <div id="shangpsx">
       <div class="title"><img src="{{asset('images/title_name_03.png')}}" /></div>
      ...
      <div id="shangpjs">
       <img src="{{asset('images/pro_img.png')}}" />
      </div>
      <div id="coms1">
